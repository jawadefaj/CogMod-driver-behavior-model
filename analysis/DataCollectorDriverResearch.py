...
class DataCollectorDriverResearch():
    ...
    def initDataDict(self):
        ...
        self.statDict = {
            "dataset_id": [], "scenario_id": [], "exec_num": [], 'agent_type': [],
    ...
    def collectStats(self, dataset_id, scenario_id, exec_num, agent_type,
                     frame, scenario_status,
                     ego_id, preceding_id, ego_agent, actor_agent):
        
        self.statDict["dataset_id"].append(dataset_id)
        self.statDict["scenario_id"].append(scenario_id)
        self.statDict["exec_num"].append(exec_num)
        self.statDict["agent_type"] = agent_type
        
        self.statDict["frame"].append(frame)
        self.statDict["scenario_status"].append(scenario_status)

        self.statDict["ego_id"].append(ego_id)
        self.statDict["c_x"].append(ego_agent.get_vehicle().get_location().x)
        self.statDict["c_y"].append(ego_agent.get_vehicle().get_location().y)
        
        self.statDict["c_speed"].append(ego_agent.get_vehicle().get_velocity().length())
        self.statDict["c_acceleration"].append(ego_agent.get_vehicle().get_velocity().length())
        self.statDict["target_speed"].append(ego_agent.motor_control.target_velocity)
        
        self.statDict["c_steer"].append(ego_agent.get_vehicle().get_control().steer)
        self.statDict["c_throttle"].append(ego_agent.get_vehicle().get_control().throttle)
        self.statDict["c_brake"].append(ego_agent.get_vehicle().get_control().brake)
        
        front_WM = ego_agent.local_map.trackedAgentManager.surrounding_agents['front']
        ...
        self.statDict["gaze_direction"].append(ego_agent.gaze.get_gaze_direction())

import os
import logging
from agents.vehicles.CogMod.CogModAgent.AgentInitializer import AgentIntializer
from agents.vehicles.CogMod.CogModAgent.CognitiveModel.Subtasks.LaneKeeping import LaneKeeping
from agents.vehicles.CogMod.CogModAgent.CognitiveModel.Subtasks.IntelligentDriverModel import IntelligentDriverModel
from agents.vehicles.CogMod.CogModAgent.RequestHandler import RequestHandler
from agents.vehicles.CogMod.CogModEnum import ManeuverType
...
class IDMAgent():
    ...
    def reset_driver(self, agent_settings, time_delta=-1):
        # self.driver_initializer.reset_driver(driver_profile, time_delta)
        idm_paramters = agent_settings['subtasks_parameters']
